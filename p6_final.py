# -*- coding: utf-8 -*-
"""P6 FINAL OLCUM (P4 yigin dogrulamasi): uzlasma yukseltici (P1) + RENK ozelligi (P2), ESLESEN gate ile.
...
P4'te yigin +0.0319 olculdu (48 parca, seed 13). Bu BAGIMSIZ dogrulama: 100 parca, seed 101,
500 egitim parcasi, test aileleri yine disarida. AYNI duzenek -> seviye ve fark birlikte gecerli.
Super-toplamsal sonuc (P1 +0.006, P2 -0.003, birlikte +0.032) bu kadar buyukse DOGRULAMA sart.
...
def main():
    ...
    print(f"P6 DOGRULAMA -- test {len(sel)} parca (70 dusuk/30 cok) | egitim {len(tr_parts)}", flush=True)
    ...
    print("makbuz -> results/p6_final.json")
