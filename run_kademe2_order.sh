...
# DAGITILAN PAKETI KORU. `run_p6_kademe2.py` cikti yolunu fixed yaziyor ve
# `regime` alanini URETMIYOR; korumasiz kosarsak D7'de measured_path paketin regime
...
for s in 1 0; do
  ...
  cp results/p6_kademe2_full.json "results/p6_kademe2_sira$s.json"
