...
NEDEN AYNI ANDA: `gate_goreli_oran` gibi anahtarlar hem koddan hem
`cp_config.json`'dan okunuyor. Birini cevirip digerini birakmak urunu
SESSIZCE bozar -- bugun tam bu turden dort bayatlama bulundu.

GUVENLIK:
  * kelime siniri (\b) ile degistirir
  * UZUN anahtar ONCE (esle_macar, esle'den once)
  * her dosya once ayristirilir (.py) -- bozulursa geri alinir
"""
import ast, io, os, re, subprocess, sys
import importlib.util as _u
_s = _u.spec_from_file_location("sz", "_ceviri_sozluk.py")
