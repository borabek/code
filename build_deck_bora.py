...
Every metric on these slides comes from a measurement receipt in results/, not from the
...
def bullets(slide, l, t, w, h, items, size=15, gap=6):
    ...
    for it in items:
        ...
        # HER madde gorunur bir im ile baslar. Onceki surumde kalin giris ifadesi imin YERINE
        # geciyordu, dolayisiyla o maddeler duz paragraf gibi duruyordu.
...
# Bos desteden basla ama tema/master'i koru. DIKKAT: yalnizca sldIdLst'ten silmek yetmez --
# slayt PARCALARI pakette kalir ve kayit sirasinda 'Duplicate name: slide1.xml' uretir; PowerPoint
# boyle bir dosyayi bozuk sayabilir. Iliskiyi de dusurmek gerekiyor.
...
def new_slide(section=None, headline=None, dark_bg=False):
    ...
    for el in banner_xml:
        s.shapes._spTree.append(copy.deepcopy(el))
    # ALTBILGI: bant RITTAL KIRMIZISI (C8102E). Uzerine acik gri yazmak metni yok ediyordu --
    # orijinal deste beyaz kullaniyor. Ad SOYAD kalin ve buyuk harf, boylece pasif kalmiyor.
