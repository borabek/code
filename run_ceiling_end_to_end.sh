...
# LOMO kurulabilir. Tek variable KORPUS (ceiling 12 vs 24); same parts, same
...
for ad in tam3 tam4; do
  ...
  if P6_DIZIN="$dz" P6_KUME=d6 P6_KAT_MIN=$KAT_MIN P6_KOLLAR=P6 \
    ...
    cp -f results/p6_kademe2_full.json "results/uctan_uca_$ad.json"
    r=$(python -c "
...
if len(r) == 2:
    ...
    print(f"{'':<14}{'ceiling 12':>12}{'ceiling 24':>12}{'diff':>10}")
