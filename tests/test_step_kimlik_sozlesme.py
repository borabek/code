# -*- coding: utf-8 -*-
"""STEP adlandirma sozlesmeleri -- DataSet 6 SESSIZ COKUSUNE karsi guard.
...
STEP sozlugunu this anahtarla kurdugu for 1655 file sessizce eziliyor and corpus 4405'te
kaliyordu. HICBIR error verilmedi -- only sayinin oynamamasi ele verdi.
"""
import os 
import sys 
...
def test_json_sozlesmesi_pid_alt_cizgili ():
    assert step_kimlik ("UTL.UUT-6S-HV-PP-GY_ElectricalTerminal_ElectricalTerminal.stp")=="UUT-6S-HV-PP-GY"
...
def test_step_ve_json_kimligi_AYNI_pid_verir ():
    """Eslesmenin kosulu: two taraf same anahtar uzayina dusmeli."""
...
def test_JSON_sozlesmeli_stepler_TEK_anahtara_dusMEZ ():
    """Asil cokus: all of them same anahtara indirgeniyordu."""
