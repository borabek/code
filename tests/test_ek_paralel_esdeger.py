...
Windows `spawn` cocuk surecte __main__'i YENIDEN ICE AKTARIR; bu yuzden test
stdin'den degil GERCEK DOSYADAN kosmali (stdin heredoc'ta asiliyor).
"""
import os
import sys
import time
...
def main():
    ...
    for blok in os.environ.get("T_BLOK", "simetri,derinlik").split(","):
        A, ta = kos(blok, n, 1)
