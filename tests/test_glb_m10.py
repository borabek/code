# -*- coding: utf-8 -*-
"""M10: FIZIKSEL KUSUR KANALI -- ayri dugum, M6'yi BOZMAZ (2026-08-05).

Sozlesmenin M6'si "RENK = ESLESME DURUMU" diyor ve denetci renk sayimlarini TP/FP/FN ile
karsilastiriyor. Kusurlari yeni RENKLERLE gostermek M6'yi bozardi. Bu testler ayrimin
korundugunu ve bayraksiz ciktinin BIT-OZDES kaldigini garanti eder.
"""
import os
import sys
...
def test_bayraksiz_cikti_bit_ozdes(tmp_path):
    """Bayrak YOKSA hicbir sey cizilmez -- eski GLB'ler aynen kalmali."""
...
def test_bayrak_ayri_dugum_uretir(tmp_path):
    """Bayrakli CP, `fiz_<ad>` adli AYRI dugum ekler."""
    import json
...
def test_bilinmeyen_bayrak_yok_sayilir(tmp_path):
    """Tanimsiz bayrak sessizce ATLANIR, cikti bayraksizla AYNI olur."""
...
def test_ayni_cp_birden_cok_bayrak(tmp_path):
    """Bir CP hem govde ici hem onu kapali olabilir -- ikisi de cizilir."""
