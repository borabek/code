# -*- coding: utf-8 -*-
"""topoloji_ailesi: sentetik klemens dizisi uzerinde elle dogrulama."""
import os
import sys
...
def _sahne():
    """5'li tel girisi dizisi (+z bakar), her birinin 10mm arkasinda vida yuvasi,
    bir de uzakta tek basina duran SAHTE aday."""
...
def test_dizi_uyesi_ile_yalniz_aday_ayrilir():
    ...
    # dizi uyesi: kendi duzleminde 4 komsu, ekseninde 1 (arkadaki vida yuvasi)
    assert X[0, ad["dik_dizi_n"]] == 4, X[0]
    assert X[0, ad["es_eksen_n"]] == 1, X[0]
    # yalniz sahte aday: ikisi de sifir
