# -*- coding: utf-8 -*-
"""GT GECERLILIK KAPISI (2026-08-04): puanlanamaz GT'li part korpusa girmemeli.

AL vakasi: 26 parcanin InsertDirection'i HARFIYEN (0,0,0) and tum CP'leri same noktada.
Urun onlarda "0.000" aliyordu -- model kotu oldugu for not, GT OLCULEMEZ oldugu for.
"""
import io 
import json 
import os 
...
def test_cakisik_noktalar_reddedilir (tmp_path ):
    """AL vakasinin IKINCI yarisi: 19 CP'nin all of them same places -> tekil esleme imkansiz."""
    from big_arbiter import gt_gecerli 
...
def test_genis_except_yok ():
    """Ilk surumde `except Exception` a NameError'i yutmus and korpusu 4432 -> 0 dusurmustu.
    O desen geri gelmesin."""
    import inspect 
    from big_arbiter import gt_gecerli 
    # YORUMLARI AT: docstring/yorumda "except Exception KULLANMA" yaziyor and first surumde
