...
2026-07-31 denetimi three SESSIZ ayrisma buldu and ucu de sayilari gecersiz kiliyordu:
...
def test_her_connection_points_cagrisi_step_path_aliyor ():
    ...
    f"ama measurement onunla yapilir; olculen urun dagitilan urun olmaz")
