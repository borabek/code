...
# a mere PAIR of fillets (old floor) must NOT fire anymore -- measured ten the
...
def test_catalog_nr_extraction ():
    ...
    # The blind `centre + depth/2` push overshot OUTSIDE the part ten funnel+bore
...
# even a stray/oversized face extent stays clamped inside the bbox
    ...
    # points" ten FOUR OR MORE faces and hold 53.6% of ALL ground truth. A wire enters a
    # terminal block through one face (two ten a feed-through), and a product accepts one
...
def test_plausible_drops_minor_face_holes ():
    """6 entries ten the front + 4 mounting/screw holes scattered over other faces."""
...
def test_radius_rule_is_scoped_to_the_kept_faces ():
    ...
    openings, a part with MANY identical screw holes ten its minor faces would make
    ...
    Here: 3 real 1.5mm entries ten +X, and 4 screw holes at 4.5mm ten other faces."""
