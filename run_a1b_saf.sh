#!/usr/bin/env bash
# A1b: DAGITILABILIR surum -- egitim korpusu buyur AMA olcum kumesi BOZULMAZ.
#
# A1a (415 mesh) "daha cok veri ise yariyor mu" sorusunu SABIT val kumesinde cevaplar,
# ama etiketlerinin 52 olcum grubuyla cakismasi yuzunden UCTAN UCA olculemez
# (olcum kumesi 171 -> 119 gruba duserdi = mevcut sayilarla karsilastirilamaz).
#
# A1b etiketleri hem LOCKED hem OLCUM gruplarindan arindirir:
#   _mfg_labels        142 -> 97 parca
#   _mfg_labels_highcp 115 ->  7 parca  (96'sinin 89'u olcum grubunda -- neredeyse tamami
#                                        olcumu yiyor, karsiliginda hicbir sey vermiyor)
# Egitim 189 -> 293 mesh (1.55x); olcum kumesi 171 grup DEGISMEZ.
#
...
echo "=== A1b: saf uretici etiketleri, k_eig 96, seed ${SEED}, $(date) ==="
