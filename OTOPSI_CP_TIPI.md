...
## DECISION DENEYİ SONUCU (2026-07-24, recon_wire_vs_tool.py, 770 robot-CP: 465 tel / 305 tool-fazla)
...
2. **DAL A (AUC yüksek):** cp_openings'e **wire-vs-tool geometrik kapısı** ekle (boyut/depth/eşlik
   eşiği). Yeniden eğitim none → each modele uygulanır. Hakemde precision↑ / tel-recall sabit doğrula.
3. **DAL B (AUC düşük):** sınıfı **un-merge et** — a parça setinde tool ağzını ayrı işaretle (insan),
   6. sınıf/alt-baş as öğret; VEYA **eşleme sezgiseli**: kutup başına tel+tool çifti tespit et,
