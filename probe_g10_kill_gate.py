...
KOLLAR ={"g7":"results/_p1_olasilik_g7","g10":"results/_p1_olasilik_g10"}
CIKTI ="results/g10_kill_kapisi.json"
...
def main ():
    ...
    fark =sonuc ["g10"]["kahin_F1"]-sonuc ["g7"]["kahin_F1"]
    gecti =fark >0 
    print (f"\nFARK (g10 - g7): {fark :+.4f}")
    print (f"KARAR: {'GECTI -- sig boyama KALIR'if gecti else 'KALDI -- sig boyama GERI ALINIR'}")
    with open (CIKTI ,"w")as f :
        json .dump ({"damga":makbuz_hash .damga (),"sonuc":sonuc ,"fark":fark ,"gecti":bool (gecti ),
