...
the in-domain refit91 model, measured ten HUMAN-GT val (leakage-safe: locked test untouched)?

REVISED 2026-07-20 (cp-v3 correction): CP placement is no longer driven by CableEntry alone --
the arbiter (measure_cp_defs.py, results/cp_def_eval.json) showed real CPs live ten Contact
