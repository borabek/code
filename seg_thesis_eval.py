...
checkpoint'in val 20-parca IoU/Dice/acc'i nedir? >=0.51 -> tezi geciyoruz; ~0.80 -> tez-native 0.80.
val = .obj + .labels.txt (vertex 5-sinif). Etiketsiz kacis (val insan-etiketi zaten var, GT-eksigi yok)."""
import os, sys, glob
