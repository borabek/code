...
#
# OLCULDU (VAL 100 part, TAM zincir, tek-vs-tek adil kiyas, `olculen` yolu):
#   A kontrol (tek ckpt) : tespit 0.5430 | robot unsigned 0.4792 | ISARETLI 0.4135
#   Y1 augment (tek ckpt): tespit 0.5808 | robot unsigned 0.5293 | ISARETLI 0.4831
...
# Bu betik seed 1 ve 2'yi ekler (seed 0 = y1_aug03_s0.pt zaten var).
set -u
cd "$(dirname "$0")"
