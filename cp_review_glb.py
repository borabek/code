...
opening. Isometric orientation so it opens on the large face.
...
def review_glb(V, F, cps, labels, out):
    ...
    # AUTO ball size so markers never visually overlap on dense parts (shrink to a fraction of the
