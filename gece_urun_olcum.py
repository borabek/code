# -*- coding: utf-8 -*-
"""GECE OLCUMU: bugunku urunun GENIS ornekte CP-F1'i (44 degil, 120 parca).

NEDEN: gunun butun kararlari 44-64 parcalik orneklerde alindi ve ayni yapilandirma farkli
orneklerde 0.65-0.78 arasi degerler verdi (ornekleme gurultusu ~±0.04). "Urun rakami" demek
icin daha genis bir olcum sart.

SIZINTI: gate 1903 parcayla egitildi, yani bu parcalari gordu -> LEHINE sizinti var.
Bu yuzden sonuc URUN RAKAMI DEGIL, bir UST SINIR olarak raporlanir. Sizintisiz sayi
K2c'dir (0.7817, 44 parca, test aileleri disarida).
"""
...
def main():
    ...
    print(f"{len(sel)} parca (80 dusuk / 40 cok) | esik {thr_lo}/{thr_hi} | min_v {pp['min_vertices']}",
          flush=True)
    ...
    print("makbuz -> results/gece_urun_olcum.json")
