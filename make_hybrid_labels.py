...
tool. Unlike pure pseudo-labels these carry real human information ten the class that matters.

Adopt only if it beats the product ten the arbiter CP F1 (0.520). Otherwise: measured negative.
"""
