...
`within_part(X, donusum)` uyguluyor (58 -> 116 column, PARCA PARCA z-skor) after
`_cokus_yonlendir` with yonlendiriyor. Parca-ici z-skor this projenin most large single
