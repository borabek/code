...
# etrafinda silindirik kabuk: signed tepe orani %0.94 -> %1.63 (elle
# etiketli corpus ~%1.5). Tek degisken ETIKET SEKLI.
#
...
# signed tepe sayisina (yogunluga) gore secildi, cunku duvar YOGUN
# parcalarda. Toplam ~689 part = A'nin 3.6 kati.
#
