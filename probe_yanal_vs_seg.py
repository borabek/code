...
SORU: lateral error, that adayin segmentasyon kalitesiyle korele mi?
  * EVET whereas -> data kollari (B9/D20/sentetik) lateral'a da etki eder, 0.45 MENZILDE
  * HAYIR whereas -> lateral `v_o`'nun ICSEL siniri, teze sadik 0.45 YOK

VEKIL OLCUTLER (candidate basina, turetmeden gelir):
  n_verts   : agzi olusturan vertex count (few vertex -> centroid oynak)
  confidence: that bolgedeki mean baglanti olasiligi (low -> seg emin not)
  area      : mouth alani
Bunlar X22'nin inside. Yanal error with ILISKI olcu + KOSULLU DAGILIM.
"""
...
print ("\nKOSULLU: en aciklayici sutunun ust/alt ceyreginde lateral <=2mm orani")
