...
# source: 0=segmentasyon 1=B-rep 2=mesh tepesi
...
def kimlikle (v ):
    """pid -> kayit. D6 parcalari kanonik `_der_yeni_G7BIRLESIK.pkl` inside YOK
    (measured: 0/468), that is why `d6_record`'a DUSULUR. Bu dusme olmadan threshold
...
def main ():
    ...
    for ad ,kaynaklar in KOLLAR .items ():
        ...
        f"D7 candidate/part {ap :.1f}",flush =True )
        en =None 
