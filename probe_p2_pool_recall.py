...
TABAN (`results/havuz_recall_d7.json`): kanonik G7 pool recall **0.6654**.
Yeni network bunu GECMEZSE arm KAPANIR and uctan uca olcume SOKULMAZ.

Aday uretimi urunun own fonksiyonuyla (`robot_cp.derive_candidates`), tespit
...
def main ():
    ...
    print ("receipt -> results/p2_havuz_recall.json")
