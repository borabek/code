...
DIAGNOSIS (2026-08-11, D6-ici LOMO): direction secimi cozuldu (kahin farki only
...
YONU kopyalaniyordu -> tespit +0.0126 but robot -0.0100. Burada direction
...
MIN_DESTEK =2 # a otelemenin gecerli sayilmasi for at least this up to double
