# -*- coding: utf-8 -*-
"""BOLME DENETIMI: egitim / dev / sinav arasinda ne sizmis?

Sonuc bir SAYI degil, uc ayri olcekte cevap -- cunku "ikiz" tanimi olcege bagli
ve tek bir sayi vermek yaniltir:

  1. PARCA KIMLIGI    tam n d6 n d7 kesisimi
  2. MARKA            marka kumeleri kesisimi
  3. TAM GEOMETRI     tepe sayisi + yuz sayisi + kutu (0.1mm)
                      -> remesh SURECLER ARASI oynadigi icin ikizleri EKSIK sayar
  4. KABA IZ          siralanmis kutu (0.5mm) + GT sayisi
                      -> remesh'ten bagimsiz, ama DIN klemensleri STANDART olculu
                         oldugu icin FAZLA sayar (farkli markanin ayni boy parcasi)

Gercek sizinti 3 ile 4 ARASINDADIR. Bu betik ikisini de yazar ve 4'e gore
"kaba iz eslesmesi OLMAYAN" D7 alt kumesini uretir; manset yaninda bu alt kumede
de olcup iki sayiyi yan yana vermek, tek sayiya guvenmekten durusttur.
...
def main():
    ...
    print(f"parca      : {out['n_parca']}")
    print(f"marka kesisim: {out['marka_kesisim']}")
