#!/bin/bash
# R3 plato testi + robot uctan-uca. Ikisi de _hw_r3.txt (145 sizinti-siz WEI parca) uzerinde.
# BA_ALLOW_SEEN=1: --only-parts acik liste zaten sizinti korumasi (liste egitilen parca icermiyor).
set -e
...
echo "############ 3) SET AUDIT (birebir ayni parca seti mi) ############"
