# -*- coding: utf-8 -*-
"""P1: PARITE korpusu ile ESKI korpus -- gate hangisiyle daha iyi?

2026-08-01 denetimi: gate egitim verisi adaylari AYRI bir yoldan uretiyordu (step_path yok,
union_all). Kod duzeltildi (`robot_cp.adaylari_uret` tek kaynak) ve korpus YENIDEN URETILDI.
Bu betik iki egitim verisini AYNI protokolde karsilastirir:

    ESKI   results/gate_regrow_data_topo.npz      (parite KIRIK: votes 12'ye kadar)
    YENI   results/gate_regrow_data_parite.npz    (urunun kendi aday ureticisi)

Beklenti bir "kazanc" DEGIL, TUTARLILIK: gate artik gercekte gordugu adaylarla egitiliyor.
Ama beklenti ile olcum ayri seyler -- karar `karar_olcutu` ile, GA'li.
...
def main():
    ...
    DON = dag.get("donusum")            # dagitilan yapiyi KORU (su an "zskor")
    ...
    print(f"\n{'veri':<8}{'aday':>8}{'parca':>8}{'votes maks':>12}{'pozitif':>9}")
    ...
    print("makbuz -> results/p1_parite_karsilastir.json")
