# -*- coding: utf-8 -*-
"""IN-DOMAIN manufacturer-CP detector on the JSON corpus (audit item 3 = the scaling path).
...
NOTE: manufacturer CP points sit ~4.7mm off-surface (standoff); the predicted centroid is on the
...
def prep(parts, radius, k_eig, dev):
    # keep operators on CPU (a 4GB GPU cannot hold all 415 parts' operators at once -> WDDM
