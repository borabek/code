# -*- coding: utf-8 -*-
"""PREVIEW CP-F1 on the dev VAL split (NOT the burned locked-11). Runs refit91.pt, turns
...
for s in samples:
    ...
    pr = cps_from_labels(V, Fc, np.asarray(pred_lbl), min_v=MIN_V)   # cleanup on predictions
