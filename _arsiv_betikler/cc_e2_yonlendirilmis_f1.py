...
SORU: robot bilinmeyen a parcada 'this very-CP' diyebilir mi? Diyebilirse conn_promote'u SADECE
...
def main ():
    ...
    print (f"ortak+geometrili skor kumesi {len (common )} part (gercek cok-CP {len (hi_true )})\n")
    ...
    for thr in (0.3 ,0.4 ,0.5 ,0.6 ):
        ...
        print (f"   threshold {thr }: dogru cok-CP {tp }/{int (yr .sum ())}, yanlis sign {fp }, kacan {fn }")
    print ()
