...
2.4'ten 4.6'ya output and gate yuku kaldiramadi (tespit -0.031). Artik "3 uye anlasti" like
...
almak sisirmedir (this gece G5'te same tuzagi olcmustum).
"""
...
MV =(1 ,2 ,3 ,4 )
print (f"\n{'min_votes':<11}{'training candidate':>13}{'tespit':>9}{'robot':>9}")
TAM ={}
for mv in MV :
