...
GT'nin %93.7'sini iceriyor" diye okudum. **YANLIS.** 0.9372 a F1'dir: kahin secimle elde
...
Bu betik UC sayiyi ayri ayri gives:
    HAM recall           : eslesen GT / total GT (parts havuzlanmis)
    AGIRLIKLI recall     : regime agirligiyla (low-CP 0.895 / very-CP 0.105)
    REJIM recall         : low-CP and very-CP ayri
and bunlardan TESPIT F1 TAVANINI (kahin secim, FP=0) turetir.
"""
import io 
import json 
import os 
...
def eslesen_gt (P ,G ,Gd ,diag ):
    """Kac GT'nin YAKININDA at least a candidate present (tespit toleransi, candidate secimi YOK)."""
...
def main ():
    ...
    print (f"\nDIKKAT: 0.9372 RECALL DEGILDIR -- kahin secimle olculen F1'dir. Gercek candidate")
