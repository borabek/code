...
WHY YAZILDI (denetim bulgusu 12): butun sayilarin dayandigi `results/_der_tam.pkl`'i
...
Kullanim:
    python turet.py --output results/_der_B.pkl --ckpt a.pt b.pt c.pt d.pt
    python turet.py --output results/_der_yeniden.pkl          # config'teki toplulukla
"""
import argparse 
import io 
import json 
