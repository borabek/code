# -*- coding: utf-8 -*-
"""Raise cp-v3 F1 by improving PRECISION on the arbiter set (recall is capped by segmentation ->
...
all connection CPs within a radius into ONE CP (the robot inserts once per terminal).
