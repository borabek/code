# -*- coding: utf-8 -*-
"""URUN v2 PAKETI: 2026-07-28/29 gecesinde olculen +0.053'luk yapilandirmayi TEK KOMUTLA produces.

    .venv/Scripts/python.exe urun_v2_paket.py            # yapilandirmayi dogrula + receipt yaz
    .venv/Scripts/python.exe urun_v2_paket.py --holdout  # KILITLI HOLDOUT single atis (geri donusu YOK)

YAPILANDIRMA (three olculen degisiklik, all of them WORK OOF with dogrulandi):
