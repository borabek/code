...
KILL: a arm, manufacturer-disi EN KOTU durumda mevcudu gecmezse and tanidik veride 0.02'den extra
...
def main ():
    ...
    def olc (M ,ad ):
        ...
        return {"tanidik":tan ,"manufacturer":mv ,"en_kotu":min (mv )}
    ...
    print ("receipt -> results/t10_olcek_bagimsiz.json")
