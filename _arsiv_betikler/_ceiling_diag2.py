...
print (f'kacirilan CP olan {len (miss )} part | ilk 30 inceleniyor',flush =True )
...
print (f'  segmentasyon ATESLEDI ama candidate olmadi : {FIRED :3d} (%{100 *FIRED /max (tot ,1 ):.0f})  -> POST-ISLEME sorunu (ucuz)')
