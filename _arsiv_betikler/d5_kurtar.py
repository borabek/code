# -*- coding: utf-8 -*-
"""DS6-5b: TURETILEMEYEN parcalari bul ve DORDUNCU KADEME ile kurtar.

NEDEN LOG AYRISTIRMIYORUZ: log yalnizca ISTISNA ATAN parcayi yazar. Bir parca baska
sebeplerle de dusebilir (surec oldurulmus, vardiya bolmesi kaymis, kayit yazilmadan
kesilmis). DOGRU tanim su: `eligible()` uygun diyor AMA hicbir shard'da kaydi YOK.
Boylece kayip parca, sebebi ne olursa olsun yakalanir.
...
def main():
    ...
    print(f"uygun korpus {len(E)} | turetilmis {len(var)} | EKSIK {len(eksik)}"
