# -*- coding: utf-8 -*-
"""R4: NOKTAYI analitik silindir eksenine IZDUSUR + askida kalan P2 gate taramasi.
...
"kahin" not, gercekten uygulanabilir a islem.
"""
import json 
import os 
import pickle 
...
def main ():
    ...
    print (f"robot-hazir 0.65 icin gereken ratio: %87.4")
