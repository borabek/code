...
HIGH_CP =8 # regime siniri (olculen medyanlar: low 2, high 12)
...
def main (limit_per_regime =45 ):
    ...
    print (f"pool: dusuk-CP {len (lo )} part, cok-CP {len (hi )} part "
    ...
    print ("receipt -> results/cc_a_vertex_aritmetigi.json")
