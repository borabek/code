...
Kod tabaninda 2mm'nin gerekcesi YOK -- `GEO_TEZE_SADIK_PLAN.md:44` only "Robot hedefi
...
`mouth_width` A0'da kalibre edildi (%1 deviation). Her eslesen CP'de agzin real ic capini
