...
Sinyal: each candidate for ROW/COLUMN-consistency = surface-eksenlerinde (u,v) hizali high-skor komsu count.
...
def consistency (P ,ws ,tol_frac =0.04 ):
    """each candidate for: u ya da v ekseninde hizali (same row/kolon) high-skor komsu agirligi."""
    u ,v =face_axes (P )
    pu =P @u ;pv =P @v 
