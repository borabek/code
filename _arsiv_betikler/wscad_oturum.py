...
NEDEN AYRI ADIM: wscaduniverse.com giris istiyor ve 3D indirme ayrica Cadenas kaydi
istiyor. Kullanicinin KENDI tarayicisindaki oturum Playwright'a GECMEZ -- Playwright
kendi profilini acar. Bu yuzden KALICI PROFIL kullaniyoruz: pencere bir kez acilir,
kullanici ICINDE giris yapar, oturum diske yazilir ve sonraki kosularda korunur.

BU BETIK INDIRMEZ. Yaptigi:
  1. Kalici profille Edge acar (headed -- kullanici gormeli)
  2. Girisi BEKLER (sayfada oturum belirteci cikana kadar yoklar)
  3. TEK bir parcanin sayfasina gider ve 3D/indirme akisinin DOM yapisini dokumler
Amac: toplu indirme dongusunu KORU KORUNE yazmamak. Akisi gordukten sonra dongu yazilir.
...
HEDEF = "8WH2040-4LF00"          # SIE, GT'si elimizde, STEP'i yok
ANA = "https://www.wscaduniverse.com/"


def giris_var_mi(page):
    """Oturum acik mi? Login baglantisi KAYBOLDUYSA ve bir hesap/cikis izi VARSA."""
    try:
        u = page.url.lower()
