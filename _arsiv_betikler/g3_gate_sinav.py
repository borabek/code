...
TABAN: dagitilan urun (4 uye, duz pool, old corpus) -> tespit 0.7584 / robot 0.5893.
...
KILL (onceden yazildi, degistirilmeyecek):
  tespit +0.01 VE grup bootstrap GA'si sifiri disliyor VE manufacturer-disi DUSMUYOR.
Sonuncusu ozellikle kritik: pool buyudugu for ezberleme riski artti and this havuzda
havuzlanmisi iyilestiren each arm bugune up to gorulmemis ureticiyi cokertti.
"""
import io 
import json 
import os 
...
def main ():
    ...
    print (f"\n{'arm':<34}{'tespit':>9}{'robot':>9}{'candidate':>8}{'candidate-recall':>13}")
