...
WHY BU SINYAL IMPORTANT: [[low-cp-information-gap]] sizintili upper sinirla kanitladi ki kalan error
...
def is_metal (rgb ):
    ...
    Kapsamayi artirmak kazanci DUSURDU: eklenen %22 nicelik as kapsama but nitelik as
    GURULTU (kontak olmayan gri yuzeyler metal sayiliyor). Bu yuzden DAR rule varsayilan.
...
def read_colored_faces (step_path ):
    ...
    (silent varsayilan, this depoda three times fake sinyal uretti).
    """
    cmap =face_colors_from_text (step_path )
    out =[]
