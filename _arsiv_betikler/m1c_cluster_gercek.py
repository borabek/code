...
Rejim ayrimi this projede two times odedi (min_v, threshold). Ama single-turetme olcumu this gece two times
yaniltti -> real 4-model union hattinda dogrulanmadan urune girmez.

Dagitilan mantigi taklit eder: before varsayilan turetme -> router -> rejime according to YENIDEN turet.
"""
...
def main ():
    ...
    print (f"{len (sel )} part (34 dusuk / 22 cok)",flush =True )
