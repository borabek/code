...
NEDEN ZORUNLU: K1'de gate-veri seviyesinde olculen +0.0096, calisan hatta -0.0010 cikti.
Onbellek yalnizca ORTALAMA olasiligi tutuyor; min_v ise HER MODELIN kendi turetmesinde
uygulaniyor, yani union yolu onbellekten dogrulanamaz. Tam cikarim sart.
"""
...
def main():
    ...
    print(f"{len(sel)} parca (24 dusuk / 20 cok)", flush=True)
    ...
    print("makbuz -> results/k4c_minv.json")
