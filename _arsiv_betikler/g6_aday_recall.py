...
SORU: G1 gorulmemis-manufacturer sinavinda FN'lerin **%68.1'inin ADAY_YOK** oldugunu showed
...
OLCU: **ADAY RECALL** = toleransta at least a candidate bulunan GT orani. Bu, `1 - ADAY_YOK payi`
    ...
    for i ,p in enumerate (pid_l ,1 ):
        ...
        try :
            ...
            for ad ,models in MOD .items ():
                ...
                cps ,probs ,_ ,_u =RC .derive_candidates (V ,F ,pbs ,yol [p ],cfg =cfg )
