# -*- coding: utf-8 -*-
"""KONTROL NOKTASI kurucusu -- "her an tam su ana donebilelim" sartinin yarisi.

Git kodu ve makbuzlari tutar; model agirliklari (pkl/pt, ~650 MB) git'e girmez.
Bu betik onlari `_KN_<etiket>/dosyalar/` altina FIZIKSEL olarak kopyalar ve
tum riskli girdilerin SHA-256'sini manifestoya yazar.

Iki kume var:
  KOPYALA  -- kanonik zincirin OKUDUGU ve benim UZERINE YAZABILECEGIM dosyalar.
              Bunlar geri alinabilir.
  DAMGALA  -- kopyalamak icin fazla buyuk olanlar (olasilik onbellekleri).
              Bunlar geri ALINAMAZ; degisirlerse `geri_al.py` BAGIRIR.
              Kural: bu betikten sonra bu dosyalara YAZMA.

Kullanim:  python kontrol_noktasi.py [etiket]
"""
import glob
import hashlib
import json
...
def dizin_parmak_izi(d):
    """Icerigi okumadan ad+boyut ozeti. Kazara degisimi yakalar, ucuzdur."""
...
def main():
    ...
    print("\nGeri donus:  python geri_al.py " + etiket)
