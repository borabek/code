...
KILL (onceden yazili): a (dusuk_oran, cok_oran) cifti, tanidik tespiti DUSURMEDEN
(>= -0.005) gorulmemis manufacturer EN KOTU durumunu artirmazsa ALINMAZ.
"""
...
def main ():
    ...
    print (f"turetme bitti | router: {hi } cok-CP / {len (DER )-hi } dusuk-CP",flush =True )
    ...
    print ("receipt -> results/t16_rejim_oran.json")
