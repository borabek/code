...
and evaluate ONLY on parts that were held out from EVERY member's training --
...
def dedup_union(node_lists, dedup_mm, min_members=1):
    ...
    union on the shared val: 190 FP, F1 55.7% vs best single 64.4%), whereas
    2-of-3 consensus keeps only detections independent seeds agree on."""
