...
KILL (baslamadan yazildi):
  ...
  * VEYA low-CP'de -0.01'den extra loss -> REDDEDILIR
  (this gece two kaldirac full this imzayla became: promote and adaptif yogunluk)

YONTEM: full corpus cikarimi pahali oldugu for before DOGRUDAN teshis --
segmentasyonun GT'lerde ATESLEME orani (T5'in ikinci adimi). Ince-ayar whereas yaradiysa
...
def main ():
    ...
    if os .path .exists (new ):
        ...
        print (f"\n{new } henuz yok -- training bitmedi")
