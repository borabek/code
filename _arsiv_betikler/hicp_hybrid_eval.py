...
Mimari: tipik part -> mevcut kilitli skor (6k union + prob:RF+SetNet, DOKUNULMADI)
...
sc6 =(d ["rf"]+d ["setnet"])/2 # kilitli final skor (tipik for)
THR6 =0.34 
...
# --- HIBRIT ALL (WORK): tipik = kilitli skor; high-CP = new arm ---
