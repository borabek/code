...
markers can be verified WITHOUT depending ten the user's 3D viewer / its camera. Angles: front,
side, top, iso. Every ball is drawn opaque ten top, so none hide behind the slab.
