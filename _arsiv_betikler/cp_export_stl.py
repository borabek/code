...
z-buffering). NOTE: STL carries NO colour -- each CP is a protruding SPHERE (a bump) on the
...
def build(V, F, cps):
    ...
    R, c = viz_semantic_full.reorient(V)          # isometric so it opens on the large face
