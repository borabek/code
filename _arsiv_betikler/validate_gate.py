...
Kapi esigi supurulur: skor<threshold which is CP atilir. Olcum:
...
Baz (gate absent) with karsilastir. Amac: precision belirgin artsin, recall ~sabit kalsin.
"""
...
def report (name ,test_mask ,score ):
    ...
    print (f"  BAZ (gate yok):        P {bp :.3f}  R {br :.3f}  ({base_tp } tel / {base_n } CP)")
