...
OLCULEN (kahin = GT'ye bakip most iyi uyeyi secmek; ULASILABILIR TARGET DEGIL, UST SINIR):
...
def main ():
    ...
    # UYE bazinda candidates: olasilik onbelleginden yeniden turet (network cikarimi YOK)
    VF ={}
    ...
    print (f"\n{'arm':<28}{'tespit':>10}{'ROBOT':>10}{'d_robot':>10}")
    ...
    print ("receipt -> results/r7_uye_oracle.json")
