"""OTONOM KAPSAMA TRENDI: %98 precision'da kapsanan CP orani, veri arttikca buyuyor mu?
Bu, 'tam otonomiye giden yol var mi' sorusunun dogrudan olcumu."""
...
print("%-34s %8s %10s %12s" % ("egitim havuzu","egitim GT","AUTO prec","CP kapsama"))
for nm,ex in (('TABAN (541 parca)',[]), ('+ yeni 220',['yeni220']), ('+ yeni + seen220',['yeni220','seen220'])):
