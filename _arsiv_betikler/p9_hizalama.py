# -*- coding: utf-8 -*-
"""P9 HIZALAMA OLCUMU (P6b ile AYNI test kumesi, seed 202) -- gecenin kapanis sayisi.
...
aile-disi OOF ile secilmis, test kumesine bakilmadan):
  ...
  B = HIZALI  : geo-orient ACIK (rt2 verisinin cikarildigi hal) + rt2 gate

Bulunan uyumsuzluk: rt2 verisi GEOMETRIK yonlendirmeyle cikarildi, ama urun onu KAPALI
calistiriyor -> gate, egitimde gordugunden FARKLI aday dagilimi skorluyor. Bu, bu gece
...
def main():
    ...
    print("makbuz -> results/p9_hizalama.json")
