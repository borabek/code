# -*- coding: utf-8 -*-
"""FB-2b: train_seg_extra.py'ye TEL/ALET yardimci kafasini ekler.

TEZ IHLALI YOK: ana 5-sinif kafasi, softmax'i ve kaybi BIT DUZEYINDE degismez.
Yardimci kafa paylasilan govdeden beslenir ve AYRI bir kayipla egitilir.
"""
import io
...
n1 = (o1
      ...
      + '            # Tezin 5-sinif etiketini DEGISTIRMEZ: ayri dosya, ayri kafa, ayri kayip.' + N
...
n3 = (
    ...
    + '                    help="ALET pozitif agirligi (olculdu: alet/tel tepe orani ~0.46)")' + N
    + o3)
s = yama(o3, n3, s)
