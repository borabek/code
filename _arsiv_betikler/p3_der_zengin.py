# -*- coding: utf-8 -*-
"""P3: OLCUM onbellegine ZENGIN sutunlari ekle (uctan uca A/B icin).

P2 aday duzeyinde +0.0231 gosterdi (konum9 +0.0114, cokyaricap24 +0.0169, hepsi +0.0231; ucu de
HER IKI ureticide pozitif). Aday duzeyi bu arastirmada ALTI KEZ yaniltti -> karar uctan uca.

Uctan uca olcum `results/_u4_der.pkl` onbellegini kullaniyor ama o yalniz 22 sutun tasiyor.
Bu betik AYNI adaylar icin 33 zengin sutunu hesaplayip yeni bir onbellek yazar. Olasilik
haritalari zaten diskte (results/_probs_*.pkl) -- ag cikarimi TEKRARLANMAZ, ~5 dk.

DIKKAT: adaylar DER onbellegindekilerle AYNI olmali. Bu yuzden yeniden turetilmiyor;
onbellekteki P/Pd/X aynen korunuyor, yalniz XR ekleniyor.
"""
import io
import json
import os
