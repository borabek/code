...
for k, pid in enumerate(pids):
    ...
    col[(L == CE)[F].any(1)] = [0.1, 0.9, 0.2]     # human opening (drawn on top)
...
fig.suptitle("SIFIR CP veren 6 parca -- yesil=insan acikligi, mavi=modelin gordugu baglanti", fontsize=12)
