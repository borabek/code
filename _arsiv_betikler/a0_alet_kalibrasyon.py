...
SINAV: bilinen geometriler (full kutu / gecisli hole / kor cep / ince yarik). Her biri
IKI halde olculur -- TAM (CSG, watertight) and REMESH (urunun gercekten gordugu hal).

KILL (onceden yazildi):
    is_inside  yanilma <= %5
    mouth_width sapmasi <= %10 (bilinen capa according to) VE isin sayisina duyarliligi <= %10
