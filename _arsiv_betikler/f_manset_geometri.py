...
parca yalnizca 765 geometri grubuna dusuyor ve parcalarin %80.1'inin korpusta bir IKIZI var.
"Test aileleri gate egitiminden cikarildi" derken gercekte yalniz test PARCALARI cikariliyordu.

Bu betik ayni duzeltmeyi URUN metriginde yapar. Cikarim GEREKMEZ: results/_final_cache.pkl
gate-ONCESI adaylari ve ozellik matrislerini tasiyor; degisen tek sey gate'in hangi adaylarla
EGITILDIGI.
"""
...
def main():
    ...
    print(f"gate havuzu {len(y)} aday")
    ...
    print("makbuz -> results/f_manset_geometri.json")
