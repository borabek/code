...
Uc arm da AYNI N. Fark only BILESIM. Olcum kumesi sabit; 3 seed.
...
def main ():
    ...
    print (f"denenecek boyutlar: {boyutlar } (tek-manufacturer kollari icin ust sinir {ust })")
    ...
    KAZANC ={}
    for N in boyutlar :
        a =SON [f"A yalniz PXC N={N }"]["pool"];b =SON [f"B yalniz WEI N={N }"]["pool"]
