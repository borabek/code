...
# density (~1-2 mm ten a 70 mm part), and ~55% of its false negatives are "MODEL
...
# weights) is a pure function of the geometry: it is precomputed ten CPU
...
# numpy FPS at <=14k points costs ~0.1 s/graph, before, cached.
...
# 36%->77% ten v14; v19 regressed to raw xyz and plateaued.
