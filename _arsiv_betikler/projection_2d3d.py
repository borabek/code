...
def _extent (lo ,hi ):
    ...
    ext [ext ==0 ]=1.0 # avoid division by zero ten degenerate axis
    return ext 
...
min_depth_extent =0.0 ):
    ...
    thickness) crops ten perfectly flat parts.
...
depth_axis =None ,front_band_frac =None ):
    ...
    The slab is unbounded along depth, so it also grabs geometry ten the BACK
