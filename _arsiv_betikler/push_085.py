# -*- coding: utf-8 -*-
"""0.85'E ITME (gece 2. hamle, makine-only). Zengin gate 0.783'e getirdi (part-out) / 0.763 (aile-out).
...
for split_nm ,groups in (("PARCA-out",G ),("AILE-out (KATI)",FG )):
    ...
    print ()
print ("KIYAS: canonical base 0.750 | gece-1 zengin gate: part-out 0.7826 / aile-out 0.7628")
