# -*- coding: utf-8 -*-
"""P2 KARAR OLCUMU: 2x2 -- AG (g5 vs g6) x YARICAP (mevcut 3/10/5 vs P1 kazanani 1/2/2).

NEDEN 2x2: ikisini ayni anda degistirip "iyilesti" demek, hangisinin ise yaradigini
GIZLER. Ayrica g6 dogrulamada g5'ten DUSUK cikti (0.5489 vs 0.5584) -- 20 parcalik
val kumesi karar icin yetersiz, gercek soru D6'da aday KAPSAMASI.

OLCU: ADAY KAHINI (mukemmel gate, one-to-one Macar) + gercek tespit (dagitilan gate v5).
Kahin gate'ten BAGIMSIZ oldugu icin agin temsil gucunu dogrudan gosterir.
"""
...
import d6_kayit
from p1_birlesme_tarama import havuz, kahin
...
def main():
    ...
    sonuc = {}
    print(f"{'ag':<6}{'yaricap':<10}{'KAHIN':>9}{'dusuk':>9}{'cok':>9}{'aday':>8}{'parca':>7}")
    for ag, kok in (("g5", "results/_p1_olasilik"), ("g6", "results/_p1_olasilik_g6")):
        ...
        for ad, (cl, de, oy) in (("3/10/5", (3.0, 10.0, 5.0)), ("1/2/2", (1.0, 2.0, 2.0))):
            ...
            sonuc[f"{ag}|{ad}"] = {"kahin": v, "dusuk": dl, "cok": ck, "aday": n_aday,
                                   "parca": n_p}
