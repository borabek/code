...
this an 0.5893. Yani tespite never dokunmadan **0.169** pay duruyor -- 0.80 tespit hedefine
...
SOZLUK KUCUK VE FIZIKSEL TUTULUR. Duzlemde 24 yonluk a yelpaze koysaydim kahin
...
KILL (onceden yazildi): kahin robot < 0.70 whereas Rota C KAPANIR, selector EGITILMEZ.
...
def main ():
    ...
    print ("receipt -> results/c1_yon_sozlugu.json")
