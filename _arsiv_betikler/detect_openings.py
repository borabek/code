# Classical (NO-ML) detector for recessed openings / sockets ten a connector mesh
# -> connection-point pseudo-labels.
#
# The connection points ten these connectors are recessed openings in the part's
# TOP face. A geometric detector finds them WITHOUT any training data, which
# (a) can beat a data-starved ML model ten a narrow part family, and (b) turns
# unlabelled .stp parts into LABELLED data to fine-tune the ML model ten.
#
...
#   - 4-connected recessed cells form one opening each -> CP at its centroid ten
...
#   python detect_openings.py part.stp --out that.json --depth-frac 0.15 # tune sensitivity
