...
Q1 (fold-disi, 1068 eslesen candidate):
...
KILL (onceden yazili): robot-hazir >= +0.02 VE tespit kaybi < 0.005, GA with kanitli.
"""
import io 
import json 
import os 
...
def main ():
    ...
    print (f"\n{'arm':<22}{'tespit':>10}{'ROBOT':>10}{'d_tespit':>10}{'d_robot':>10}")
    SON ,PARCA ={},{}
    for ad ,kw in KOL :
    ...
    print ("receipt -> results/q2_pose_uctan_uca.json")
