# -*- coding: utf-8 -*-
"""R6: NOKTAYI eksene izdusurme UCTAN UCA (R5 gate taramasindan turetildi) (kodda ASILI kalan "P2 taramasi").
...
def main ():
    ...
    for gate in KAPILAR :
        ...
        # KILL (onceden yazili): robot-hazir >= +0.01 BUYUKLUK, tespit >= -0.005,
        ...
        print (f"{str (gate ):<10}{s_ ['tespit']:>9.4f}{s_ ['robot']:>9.4f}{dt :>+10.4f}{dr :>+9.4f}"
    ...
    with open ("results/r6_izdusum_uctan_uca.json","w",encoding ="utf-8")as f :
        json .dump ({str (k ):v for k ,v in SONUC .items ()}|{"kazanan":kazanan },f ,indent =1 )
    print ("receipt -> results/r6_izdusum_uctan_uca.json")
