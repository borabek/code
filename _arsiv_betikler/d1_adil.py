...
Boylece olculen sey saf: gate'in EGITIM dagilimi with CALISMA dagiliminin uyusmasi ne kazandiriyor.
"""
...
def main ():
    ...
    ("B_yeni_mantik","results/gate_regrow_data_rt2.npz")):
        ...
        gates [tag ]=path 
        print (f"  {tag }: {int (keep .sum ())} candidate ile egitildi",flush =True )
    ...
    for mfg ,pid ,jf ,stp ,n in sel :
        try :
            ...
            for model ,meta in models :
                ...
                # CALISMA mantigi: promote'suz turet -> router -> very-CP whereas promote'lu
            def der (pr ):
