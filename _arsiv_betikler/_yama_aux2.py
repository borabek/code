...
Ana 5-sinif yolu degismez: `out = D._forward(...)` ve `loss = D._compute_loss(...)`
aynen kalir. Yardimci kafa `last_lin` ONCESI gizli temsilden (128-d) beslenir --
govde paylasilir, cikis ayridir.
"""
import io
...
# --- 4) modelden SONRA yardimci kafayi kur ve optimize edilecekler listesine kat
...
# --- 5) kayba yardimci terimi EKLE (ana kayip hesaplandiktan SONRA)
o5 = "            loss.backward(); opt.step(); tot += float(loss)"
n5 = (
    '            # FB-2 YARDIMCI KAYIP: ana kayip yukarida hesaplandi ve DEGISMEDI;' + N
...
print("4-6 yamalandi: yardimci kafa + kayip + checkpoint")
