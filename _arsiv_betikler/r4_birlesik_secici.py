...
R1 BULGUSU: two dictionary TAMAMLAYICI -- ayri ayri kahin %87.5 and %81.5, BIRLIKTE %94.1
...
if os .path .exists (ONB ):
    PARCA =pickle .load (open (ONB ,"rb"));print (f"sozluk onbellekten: {len (PARCA )} part",flush =True )
else :
    PARCA ={};t0 =time .time ()
...
print ("receipt -> results/r4_birlesik_secici.json")
