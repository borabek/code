...
def main ():
    ...
    for r in DER :
        ...
        # 2 +kahin YON: eslesen adaylarin yonu GT yonu is done
        Pd2 =Pdk .copy ()
        ...
        # 3 +kahin KONUM: eslesen adaylarin lateral sapmasi da sifirlanir (GT noktasina tasinir)
        P3 =Pk .copy ()
    ...
    print (f"  direction+konumu mukemmellestirme     : robot {OUT ['3 +kahin KONUM']['robot']-kg_r :+.4f}")
