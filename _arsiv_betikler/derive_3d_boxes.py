...
tespit agi for anchor tasarimina and training etiketlerine temel.
Neden bizim for correct hedef: bugunku zayifligimiz INSTANCE AYRIMI (fragment/clustering); tespit agi
...
def main ():
    ...
    print (f"\n=== 3D KUTU TURETIMI ===")
    print (f"  part: {len (per_part )} | kutu yazilan part: {n_written } | toplam instance: {int (nb .sum ())}")
