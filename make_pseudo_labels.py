...
What IS still available: 3571 UNLABELLED WSCAD parts. The model fails ten the 22 hard queue parts, but
is confident ten many easy ones. Standard semi-supervised recipe: keep only the most CONFIDENT parts,
use the model's own prediction as a pseudo-label, add to training, and MEASURE ten human-GT val.
