...
on the queue parts (batch 1 _label_targets = 20, batch 2 _label_targets_2 as they arrive). Deriving
...
tolerance -> P / R / F1, plus approach-direction agreement on matched pairs.
...
def main():
    ...
    # parts this ckpt may have been trained on (batch-1 dir is used as --partial-dir for human20*)
    ...
    for root in a.dirs:
        for d in sorted(glob.glob(os.path.join(root, "*"))):
            ...
            for pi, gi in pairs:   # direction agreement on matched pairs
