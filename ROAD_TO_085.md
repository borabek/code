...
- WSCAD katalog-bagli parts icin gercekci
...
- **LEVER-2 DUZELTILDI:** her manufacturer KENDI modeli:
   - WEI modeli = B_rec (recall-fav+last, WEI-only) = 0.558 CONFIRMED
   - PXC modeli = ayri (PXC etiketleri + recall-fav, WEI'siz)
- Router: part-manufacturer -> ilgili model. (Robot zaten manufacturer biliyor.)
- Bu, dilusyon sorununu cozer; her manufacturer kendi zirvesinde
...
### W1. GT-TAMLIK AUDIT (ONCE — belki 0.58 PESIMIST) [measurement, buyuk potansiyel]
...
- 20 WEI FN-agir parcada A/B (tum corpus riske atmadan)
...
- 2D-render kolu (WEI DUZ opening gorsel belirgin) -> multimodal
...
### KESIN OLAN: her lever OLCULECEK. 0.85 gelirse evidence; gelmezse durust ceiling.
