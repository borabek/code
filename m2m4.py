# -*- coding: utf-8 -*-
"""M2 (conn_promote) + M4 (ince esik izgarasi) -- YENI gate altinda, GERCEK boru hatti."""
...
def main():
    ...
    print(f"TABAN (promote 0.25, esik {TL}/{TH}): {res['base']['w']:.4f}"
    ...
    print("\nM4 -- ince esik izgarasi (dusuk-CP):", flush=True)
    res["m4"] = {}
