...
#
# Diger butun settings `_p6_oz_tam3` with BIREBIR same tutulur; otherwise iki corpus
# kiyaslanamaz ve kazanc tavana mi baska a seye mi ait, ayirt edilemez.
#
# 5 pay: makinede 16 cekirdek present ve same anda night programinin B fazi with EK
...
wait
say "=== CEILING-24 CIKARIMI BITTI -- $(ls results/_p6_oz_tam4 2>/dev/null | wc -l) file ==="
