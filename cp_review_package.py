...
The candidates are the human-REGION-derived CPs (cp_openings on the human labels) -- your job is
...
def _angles(V):
    """Face-on + oblique views down the THIN bbox axis (the face the openings sit on), so all
    CPs show instead of being edge-on."""
