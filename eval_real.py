# -*- coding: utf-8 -*-
"""Score a checkpoint against the REAL Desktop\\JSON labels on the frozen real-val.
...
per.sort()
print("en kotu 5 parca:", [(round(j, 2), pn) for j, pn in per[:5]])
print("en iyi 5 parca :", [(round(j, 2), pn) for j, pn in per[-5:]])
print("DONE")
