...
Tez *izotropik* remesh diyor: **uniform vertex YOĞUNLUĞU**. Biz fixed vertex *SAYISI* kullanıyoruz.
...
- [ ] **A1 — Adaptif hedef.** `target = alan_mm² × 0.790` (fixed yoğunluk). Çok-CP medyanı için
...
- [ ] **D1 — "Geometri why yetmez" bölümü.** Elimizde bunun için sağlam kanıt present ve this, tezin
      *segmentasyon kullanma gerekçesini* güçlendirir:
      ...
      - hayatta remaining FP'ler mevcut 41 özellikle AUC 0.36/0.61
