...
0.90 cikmaz; gecen ayki sahte 90 muhtemelen tam this karisimi tek sisik sayiyla
ortmekten geldi.
...
2. **MARKA CARKI:** bilinmeyen a markanin ilk parcalari geldiginde low
   kapsama with baslar, operator onaylari ETIKET olur, o brand egitime girer →
   "bilinen"e doner → sonraki modelleri high F1 bandina gecer. Bu akista each
   brand a kez "yeni"dir; cark, bilinmeyen havuzunu surekli kucultur.
