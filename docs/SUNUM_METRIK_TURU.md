...
DOKUNULMADI** -- this dosya o turu mekanik hale getirmek icindir.
...
| 9 | sinif bazli IoU (5 satir) | 77.3 / 68.8 / 64.6 / 64.2 / 45.4 | same model -> gecerli |
...
1. **Alan farki +0.2468** (tanidik manufacturer 0.5603 / gorulmemis 0.3135).
   Ayni sistem, same veri, only split tipi different. Projenin nereye
