...
| ceiling | yonlu recall | option maliyeti |
|---|---|---|
| 12 | 0.5913 | 1.00x |
| 24 | 0.8755 | 1.33x |
| 48 | 0.8755 | 1.35x |
...
- **SIRA kapali (u25 baseline)** (results/_p6_oz_u25) selected=P6 -> P6 0.3091, P6_KAFES 0.2938
- **SIRA acik (u25)** (results/_p6_oz_u25) selected=P6 -> P6 0.3091, P6_KAFES 0.3041
- **B1 zor negatif (tam3)** (results/_p6_oz_tam3) selected=P6 -> P6 0.3195
- **son kosu (uzerine written)** (results/_p6_oz_tam3) selected=P6 -> P6 0.3195
...
1. **Havuzla:** verimlilik fixed kalirsa tavanin **1.3707** olmasi gerekir  -> 1.0'i asiyor, TEK BASINA IMKANSIZ
2. **Seciciyle:** ceiling fixed kalirsa verimliligin **59.0%** olmasi gerekir (1.62x iyilesme)
...
## 4. GECE FAZLARI
- [00:14:14] BITTI: A1b -- 141 file
- [04:12:23] BITTI: A1b -- 3051 file
...
- `d7_baseline`: **OLCULMEMIS_varsayilan_dolgu** (2001 isaretin hepsi same score)

> Gorulmemis markada robot HER isarete otonom guveniyor. Esigi yukseltmek kurtarmiyor (0.95'te bile precision ~0.47). Oneri: unseen brand for AUTO katmani KAPATILSIN.

## 5. D7 OKUMA #2 KARARI
- kapiyi passing blok sayisi: **0**
- this bloklarin total kazanci: **+0.0000** (gate +0.10)

**DECISION: D7 OKUNMAZ.** Kumulatif kazanc kapinin altinda; okuma HARCANMAZ. Butcede remaining okuma sayisi degismez.
