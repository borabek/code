...
Asagidaki yarim kalan olcumlerin hicbiri this sayilari degistirmez;
...
Sonda kancalari only `olculen` yoluna ulasir; dagitim karari for
...
## HATIRLATMA — this gece ogrenilen dort measurement kurali
