...
# format so the trained detector can run ten it -- WITHOUT any ground-truth labels.
#
...
# only the thin "mesh (V,F) -> ABB dict -> JSON" step ten top.
#
# Usage:
...
#
# Then detect connection points ten it:
...
def mesh_to_abb_dict (part_nr ,V ,F ):
    ...
    ConnectionPoints is intentionally empty: this is for INFERENCE ten an
