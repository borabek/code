...
WITHOUT retraining, run the SAME checkpoint on the 9 STEP twins under different
...
structure and bring STEP toward the JSON density the model was trained on. If a policy
lifts STEP F1 toward the JSON ceiling, mesh-density parity is a real lever (=> bake it
into train+inference). Leaky diagnostic on the 9 seen bridge parts, not a reported score.
