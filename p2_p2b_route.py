...
Bulgu: SetNet WEI'de 0.6813 -> ~0.729 (+0.048) ama PXC'de -0.011 -> ALL'da kayboluyor.
Test: WEI adaylari SetNet, PXC adaylari RF/ensemble ile puanlansin; esikler uretici-basina
nested-CV ile secilsin; TP/FP/FN HAVUZLANIP TEK AGREGAT F1 raporlansin (kullanicinin istedigi form).
Skorlar diske kaydedilir (P7'de yeniden egitim gerekmesin)."""
import json
...
def nested_counts(sc, m, K=5):
    """uretici-ici nested esik; HAM SAYILAR doner (havuzlama icin)."""
...
print(f"\n{'skor':16s} {'WEI F1':>8s} {'PXC F1':>8s} {'ALL(havuz) F1':>14s}")
per = {}
