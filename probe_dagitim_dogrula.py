...
and D7'de olcer. Beklenen: robot ~0.3090 (ayri betiklerde olculen value).
...
# POZ KAFASI: dagitilan yolda OPEN (varsayilan). P6 kolu yonu KENDISI sectigi
...
def main ():
    ...
    if N :
        ...
        # (B-rep + ~2000 secenek for isin atisi); 835 part single islemde saatler
        # takes. Paylar `birlestir_makbuz.py` with birlestirilir; mikro F1 part
    ...
    print (f"D7 {len (secili )} part | genis arm {'ACIK'if product_genis .ACIK else 'KAPALI'}",
    flush =True )
    ...
    for i ,pid in enumerate (secili ,1 ):
        ...
        # writes. Sonuc makbuzda real skor like durur and precision-kapsama
        # analizinde "each esikte %100 AUTO" diye okunur -- i.e. OLCUM BOSLUGU
        # FINDING sanilir. (d7_taban.json'da 2001 skorun all of them full 1.0 boyle
        ...
        # (skor, dogru_mu) ciftleri -> precision-kapsama egrisi
    ...
    "n_parca":len (secili ),"genis_acik":bool (product_genis .ACIK ),
