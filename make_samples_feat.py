# Generate synthetic ABB-style parts whose connection points sit ten a
# DISTINCTIVE geometric feature (a raised boss / socket), unlike make_samples.py
# whose CPs are at geometrically indistinguishable spots ten a flat plate.
#
...
# sockets / raised terminals rather than arbitrary points ten a flat face.
#
