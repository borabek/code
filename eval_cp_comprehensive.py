...
GT uses min_v=5 (light), model uses --min-v (cleanup, default 10). Dev preview ten val; a
held-out estimate ten test_locked with the val-selected min_v (no test tuning).
