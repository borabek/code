...
WHY: measurement kumesi 194 part and dagilimi **WEI 103 / PXC 90 / WAGO 1**. Yani "unseen
a WSCAD parcasinda CP bul" hedefi ([[robot-goal-and-training-sources]]) this kumeyle
ciddi olcekte SINANAMIYOR. [[gate-manufacturer-disi-cokusu]]: gate unseen ureticide
...
CIKTI ="results/d5_4_exam_set.json"
...
def main ():
    ...
    print (f"KATMAN 1 manufacturer: egitimde {len (egitim_mfg )} manufacturer present "
    ...
    print (f"GT'si + adayi which: {len (tekil )} part")
    ...
    #
    # WHY FILTRE SART: cerceve bozuksa measured_path sey URUNUN BASARISI DEGIL, hizalamanin
    # basarisizligidir. Bu parts sinavda kalirsa "unseen ureticide cokuyor"
    ...
    print ("         corpus buyudukce YENIDEN URETILIRSE muhur degisir and comparison bozulur.")
