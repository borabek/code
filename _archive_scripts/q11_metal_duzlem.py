...
metal mesafesini only metal SILINDIRLERDEN hesapliyor (q8'de measured_path AUC 0.639 da oyleydi).
...
def main ():
    ...
    print (f"{len (Y )} candidate | TP {int (Y .sum ())} | renk cozulen part: silindir-path {kab_c }, "
    f"tum-yuz path {kab_t } / {len (parts )}")
