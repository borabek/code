...
YONTEM: N parcayi AYNI surecte two times derive (process-ici kararlilik) and also this betigi
...
Olculen: candidate count farki, point eslesme orani, and part basina detection F1 farki.
"""
import io 
import json 
import os 
