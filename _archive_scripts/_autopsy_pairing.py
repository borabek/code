...
def main ():
    ...
    print (f"  total CableEntry bileseni: {tot_ce }")
    print (f"  total Contact bileseni:    {tot_ct }")
    ...
    print ("\n  at most YALNIZ-Contact'li 8 part (pid, #CE, #CT, paired, only):")
    for pid ,nce ,nct ,p ,l in per_part [:8 ]:
        print (f"    {pid }: CE {nce }  CT {nct }  paired {p }  only {l }")
