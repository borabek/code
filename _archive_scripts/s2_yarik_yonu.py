...
olmaz -- YENI BIR OZELLIK detection etmek is required: telin girdigi YARIGIN kendisi.
...
SORU (single and net): dik sinifa entering each CP for, YAKININDA yonu GT with uyusan a yarik adayi
