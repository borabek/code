# -*- coding: utf-8 -*-
"""W1 GORSEL ADJUDICATION: WEI part -> mesh (gri) + manufacturer CP (YESIL) + model prediction (KIRMIZI).
Kirmizi-only (FP) = modelin bulup manufacturer'in listelemedigi opening. Kullanici bakip
'real kablo girisi mi?' der -> GT missing mi (0.58 pesimist mi) belli becomes. GLB -> Windows 3D Viewer."""
import os ,sys ,json 
...
for m ,pid ,jf ,stp in parts :
    ...
    for p in P :scene .append (sphere (p ,r *0.8 ,[230 ,0 ,0 ,255 ]))# KIRMIZI = model prediction
