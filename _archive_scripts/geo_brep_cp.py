...
WHY DEGERLI (2026-07-29 gecesinin most angle bulgusu):
  ML kolu URETICI-DISI bolunmede 0.35'e dusuyor -- i.e. unseen a ureticide cokuyor.
...
WHY SIMDI MUMKUN: bugun two new alet kazanildi --
  1. running isin motoru (cp_geometry.ray_hits; onceden rtree yoklugunda sessizce patliyordu)
...
belirli yaricapta, yuzeye opened, belirli derinlikte silindirik (ya da prizmatik) a hole.
...
MIN_DEPTH =2.0 # channel at least this up to deep must be (mm)
