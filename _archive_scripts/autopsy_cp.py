...
Bu betik HICBIR SEYI DUZELTMEZ. results/autopsy_cp.json produces.
"""
...
def main ():
    ...
    for pid in PARCALAR :
        ...
        if not stp or not jf :
            print (f"{pid }: file none");continue 
        stp ,jf =stp [0 ],jf [0 ]
    ...
    with io .open ("results/autopsy_cp.json","w",encoding ="utf-8")as f :
        json .dump (RAPOR ,f ,indent =1 )
    print ("\nmakbuz -> results/autopsy_cp.json")
    print ("\nOKUMA KILAVUZU:")
