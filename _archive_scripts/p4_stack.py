# -*- coding: utf-8 -*-
"""P4 YIGIN TESTI: uzlasma yukseltici (P1) + RENK ozelligi (P2), ESLESEN gate with.
...
def main ():
    ...
    print (f"test {len (sel )} | training {len (tr_parts )} (test aileleri disarida)",flush =True )
    ...
    open ("results/p4_stack.json","w"),indent =1 )
    print ("receipt -> results/p4_stack.json")
