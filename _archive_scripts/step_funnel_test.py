...
print (f"FRAME sanity: GT'lerin {gt_hit }/{gt_tot } = {gt_hit /max (gt_tot ,1 ):.2f}'i a silindire denk (dusukse frame bozuk)")
...
print (f"  wire'da koni-present ratio: {HC [Y ==1 ].mean ():.2f} | non-wire'da: {HC [Y ==0 ].mean ():.2f}")
