...
def main ():
    ...
    print (f"{len (sel )} part (80 dusuk / 40 very) | threshold {thr_lo }/{thr_hi } | min_v {pp ['min_vertices']}",
    flush =True )
    ...
    open ("results/night_product_measurement.json","w"),indent =1 )
    print ("receipt -> results/night_product_measurement.json")
