# -*- coding: utf-8 -*-
"""PARCA-ICI z-score baglamini URUNE AL (gate 22 -> 44 column).

RATIONALE -- UCTAN UCA measured (results/u4_part_ici_end_to_end.json, 200 part, eslestirilmis
bootstrap %95 GA):

    split                    22 column   44 column     difference   %95 GA
    unseen manufacturer WEI     0.4832     0.5702   +0.0869  [+0.048, +0.126]   <- TARGET
    unseen manufacturer PXC     0.7203     0.6828   -0.0375  [-0.065, -0.009]   <- GERCEK BEDEL
    familiar (DEV+VAL)          0.7410     0.7390   -0.0023  [-0.023, +0.019]   (noise)

Onceden yazili kill: familiar >= -0.01 VE unseen manufacturer EN KOTU >= +0.01 -> GECTI.
...
Bu night ExtraTrees'i full da this sekle benzedigi for OLDURMUSTUM; difference measured and YAPISAL:
...
def main ():
    ...
    with open (PKL ,"wb")as f :
        ...
        "note":("PARCA-ICI 2026-08-01: 22 ham column + 22 part-ici z-score. Gorulmemis "
        "ureticide EN KOTU state 0.4832 -> 0.5702 (GA [+0.048,+0.126]), familiar "
        ...
        "was tried and failed (u5_takas.json). Onceki model: "
    ...
    "results/wire_gate.pkl. Olcum: results/u4_part_ici_end_to_end.json")
