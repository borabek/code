...
def main ():
    ...
    for i in idx_s :
        ...
        # --- feature tensor (incl. normal/curvature compute ten CPU) ---
        _sync (DEV )
        tf0 =_t ()
        ...
        # ~3.7 GB ten a 4 GB card is a 10x slowdown, not an OOM error
    ...
    # -----------------------------------------------------------------------
    # Batching benchmark: compare serial vs batched throughput ten small parts
    # -----------------------------------------------------------------------
