...
## Neden this is
Olculdu (D7 unseen brand, 3087 CP): mouth cevresindeki segmentasyon
...
def main ():
    ...
    missing =[p for p in pids if p not in S ]
    if missing :
        raise SystemExit (f"STEP bulunamayan {len (missing )} part: {missing [:5 ]} "
