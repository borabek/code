...
def main ():
    ...
    for ad ,v in (("KACIRILAN (FN)",kf ),("rastgele point",kr ),("matched (TP)",kt )):
    ...
    with io .open ("results/t3b_lattice_tamamlama.json","w",encoding ="utf-8")as f :
    ...
    print ("receipt -> results/t3b_lattice_tamamlama.json")
