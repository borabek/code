# -*- coding: utf-8 -*-
"""P6b FINAL OLCUM -- gecenin kapanis count.
...
aile-disi OOF with secilmis, test kumesine bakilmadan):
  ...
  C = P7-6uye (+MEDYAN): p5 gate with ILK SINYAL (own distribution gate'i absent -- gosterge niteliginde)
...
def main ():
    ...
    print ("receipt -> results/p6b_final.json")
