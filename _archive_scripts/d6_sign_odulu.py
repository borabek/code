...
Otopsi: detection TP'lerinin **%28.3'u** (335/1185) `Pd . Gd < 0`, i.e. point DOGRU,
axis DOGRU, only YON TERS. Bu robot metrigini single basina oldururken tespiti
never etkilemiyor (detection unsigned).
...
MAKBUZ ="results/d6_sign_odulu.json"
...
def main ():
    ...
    for pid ,r in rec_ .items ():
        ...
        # Isaretsiz esleme yapip, matched ciftte isareti GT'ye according to duzelt.
        Dk =D .copy ()
        if len (P )and len (G ):
    ...
    print ("TERS ISARET URETICI KIRILIMI (detection TP'leri inside):")
    ...
    print (f"\nISARET CEVRILSE TERS OLANLARIN KADERI ({tt } count):")
