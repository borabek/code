...
def main ():
    ...
    for k in SON :
        ...
        f"{SON [k ]['havuzlanmis']['detection']-tb ['havuzlanmis']['detection']:>+11.4f}"
    ...
    and SON [k ]["havuzlanmis"]["detection"]-tb ["havuzlanmis"]["detection"]>=-0.005 ]
    ...
    with io .open ("results/g1b_transfer_durust.json","w",encoding ="utf-8")as f :
        json .dump ({"sonuc":{str (k ):{"havuzlanmis":SON [k ]["havuzlanmis"]["detection"],
