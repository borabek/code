...
FN REASON ETIKETI -- three bucket, ONBELLEKTEN conclusive ayrilabiliyor:
...
Bu ayrim onemli because three bucket UC AYRI kola bakar: ADAY_YOK -> F4 (temsil), GATE_REDDI ->
...
[[fizik-bayes-tavanini-oynatmiyor]]: bunlar TAVANI oynatmiyor but HATA TARIFI for valid --
...
CIKTI ="results/f0_4_error_bank.json"


def esle (P ,G ,Gd ,tol ):
    """Metrikle AYNI tekil eslesme. Doner: (candidate->gt sozlugu, unmatched gt listesi)."""
...
def main ():
    ...
    f"<- hafizadaki %93.7 with KIYASLANABILIR which number budur")
