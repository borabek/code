# -*- coding: utf-8 -*-
"""D6-6b: TEMIZ unseen-manufacturer sinavinda DURUST TABAN.

WHY: old exam kumesi (`d5_4_exam_set.json`) URETICI duzeyinde kirlenmisti --
seg oto-label korpusu that kumenin 250 parcasindan 169'unu and exam ureticilerinden 958
parcayi iceriyordu. Orada measured_path 0.6050 SISIK. Yeni cluster (`d6_exam_set.json`,
...
MAKBUZ ="results/d6_temiz_measure.json"
ROBOT_YANAL =2.0 
ROBOT_ACI =10.0 
...
def main ():
    ...
    print (f"turetme kaydi found: {len (rec_ )}/{len (PID )}")
    ...
    for pid ,r in rec_ .items ():
        ...
        # DAGITILAN gate 58 sutunla egitildi and part-ici z-score onu 116'ya removes.
        ...
        # full this hatayi yaptim: 0.2353 aslinda "detection toleransi + angle<=10" idi),
