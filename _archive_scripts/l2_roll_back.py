...
KAYBETTI (results/exam_val.json). Onceden written rule: "DEV'de kazanip VAL'de kaybeden arm
...
def main ():
    ...
    "+0.0066 kazanmisti but SECILDIGI kumeydi; ayrik VAL kumesinde -0.0111 detection "
    "/ -0.0104 robot KAYBETTI (results/exam_val.json). Onceden yazili kill kurali "
