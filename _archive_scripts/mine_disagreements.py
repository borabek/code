# -*- coding: utf-8 -*-
"""Mine MODEL-vs-HUMAN disagreements ten the TRAINING parts, for targeted adjudication.
...
So: find every region the model calls Connection that the annotator did NOT mark, ten the parts we
already train ten. Each one is worth adjudicating and is useful either way:
...
TRAIN_DIRS =["_label_targets","_label_targets_2","_label_targets_3"]# batch-4 EXCLUDED ten purpose
...
def main ():
    ...
    print (f"  part basina average {len (rows )/max (n_parts ,1 ):.1f}")
