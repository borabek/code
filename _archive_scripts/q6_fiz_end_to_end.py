...
def main ():
    ...
    print (f"{len (DER )} part | {nad } candidate (AYNI pool, uc arm for de)",flush =True )
    ...
    print (f"\n{'gate':<24}{'detection':>9}{'ROBOT':>9}{'conclusive':>9}{'recall':>9}")
    R ={}
    ...
    print (f"\nKILL: uctan uca detection artmazsa DAGITILMAZ -> total {dd :+.4f} => "
