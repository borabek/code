...
"silindiri olmayan" parcalarda da works):
  ...
  BOSLUK (free-space) YONU: adaydan produced isinlarin EN UZUN engelsiz gittigi direction.
    Tel giris kanali tanimi geregi most deep bosluktur.
...
def bosluk_yonu (mesh ,p ,n =N_ISIN ,max_mm =40.0 ):
    """Adaydan most UZUN engelsiz giden direction. Tel kanali most deep bosluktur."""
    D =_fibonacci (n )
    try :
