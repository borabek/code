...
Deploy-edilebilir feature'lar (label GEREKMEZ, inference'ta hesaplanabilir):
  f1 cos(dir_i, sayim-baskin axis)   f2 cos(dir_i, gate-score-agirlikli konsensus)
...
print (f"  same-boyut RASGELE: {nul .mean ():.3f}")
print (f"  GERCEK FAZLA      : {obs .mean ()-nul .mean ():+.3f} | parcalarin %{100 *np .mean (obs >nul ):.0f}'inde TP more dense")
