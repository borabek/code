...
W2 SONUCU: prospektif (109 unseen part) 0.6510 -> 0.6901, +0.0391,
...
(part-ici z-score), RF ayarlari, candidate ureticisi, threshold -- all of them AYNI.
"""
import hashlib 
import io 
import json 
...
def main ():
    ...
    print (f"  GERI DONUS: `python w3_distribute.py --geri` (file kopyasi DEGIL, tarif)")
    ...
    "evidence":"results/w2_data_etkisi.json",
