...
degerlidir. "Dokunmadik" demek yetmez; evidence is required. Ve this night ogrendik ki a times
...
Cikti: results/q2_exam_butunlugu.json -- each sart for GECTI/KALDI + ihlal listesi.
...
def main ():
    ...
    print (f"\nLOCKED total {len (locked )} | grup-temiz {len (temiz )}")
    ...
    with io .open ("results/q2_exam_butunlugu.json","w",encoding ="utf-8")as f :
        json .dump (RAPOR ,f ,indent =1 )
    print ("receipt -> results/q2_exam_butunlugu.json")
