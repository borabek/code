...
This module combines all standalone demo scripts:
  - test_alignment()   : bbox-aligned normals ten tilted meshes
  - test_normal()      : normal vector computation ten funnel meshes
...
def test_alignment ():
    """Test bbox-aligned normals ten tilted meshes."""
    print ("\n"+"="*70 )
...
def test_normal ():
    """Test normal vector computation ten funnel meshes."""
    print ("\n"+"="*70 )
...
def test_projection ():
    ...
    for crop in crops :
        ...
        # Run full connector pipeline ten the crop
