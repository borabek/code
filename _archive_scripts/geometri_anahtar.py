...
YAZMIYOR** -- `_der_tam.pkl`'in provenance bosluguyla same state (derive.py that bosluk for
...
BBOX_KOVA =0.5 # mm -- remesh gurultusu ~0.4mm, bucket ondan large must be
...
def key_ (V ,F ):
    ...
    # KABALASTIRILDI (first version 5/5 kacirilan ikizde SUCLUYDU): 12 bucket + %1 yuvarlama
    # single kovada 1 PUANLIK tesselasyon gurultusuyle anahtari degistiriyordu
    # (h0.4.7... vs h0.5.7...). 8 bucket + %5 step, gurultuye dayanikli.
    c =V .mean (0 )
