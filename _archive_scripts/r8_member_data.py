...
Bu betik each BIRLESTIRILMIS CP for, ona katkida found UYE adaylarini and each uyenin
...
UYE OZELLIKLERI (calisma aninda hesaplanabilir, GT'ye BAKMAZ):
    ...
    n_uye         this CP'ye katkida found uye count
...
def main ():
    ...
    print (f"   'direction correct' orani {Y .mean ():.1%} | skipped {skipped }")
