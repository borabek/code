...
Kullanim: python p2_setnet.py [--emb]"""
...
if USE_EMB :
    ...
    print (f"embedding dahil ({EM .shape [1 ]}d), matched candidate {int (ok .sum ())}/{len (Y )}")
...
class SetNet (nn .Module ):
    """DeepSets + self-attention: candidate-ici temsil + part-ici baglam -> score."""
...
b =res ["rf_base"]["ALL"]
print (f"\n=== GO/NO-GO (family-out'ta RF tabanina per >= +0.010 VE 3 seed kararli) ===")
