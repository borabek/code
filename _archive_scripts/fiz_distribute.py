...
RATIONALE -- uclu split kuralini gecti (`results/q6_fiz_uctan_uca_{dev,val}.json`):
    ...
    arm                     DEV detection   VAL detection
    rt2 13 (dagitilan)        0.7089       0.6417
    guncel hat, 13 column      0.6938       0.6477
    guncel hat, 18 column      0.7567       0.7326

    OZELLIK etkisi  detection  DEV +0.0628 [+0.0228,+0.1061]  VAL +0.0854 [+0.0406,+0.1306]  IKISI DE BELIRGIN
    TOPLAM          detection  DEV +0.0481 [+0.0083,+0.0915]  VAL +0.0911 [+0.0523,+0.1324]  IKISI DE BELIRGIN
...
Karar kumesinde kazandi, AYRIK exam kumesinde dogrulandi, four measurement de belirgin. Bu night olen
...
def main ():
    ...
    "bos_derinlik, passing). Uctan uca DEV +0.0481 / VAL +0.0911 detection, ikisi de "
