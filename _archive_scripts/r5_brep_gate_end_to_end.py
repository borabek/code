# -*- coding: utf-8 -*-
"""R5: BREP_MAX_OFF kapisi UCTAN UCA (kodda ASILI remaining "P2 taramasi").
...
def main ():
    ...
    for gate in KAPILAR :
        ...
        print (f"{gate :<8.1f}{s_ ['detection']:>9.4f}{s_ ['robot']:>9.4f}{dt :>+10.4f}{dr :>+9.4f}"
    ...
    with open ("results/r5_brep_gate.json","w",encoding ="utf-8")as f :
        json .dump ({str (k ):v for k ,v in SONUC .items ()}|{"kazanan":kazanan },f ,indent =1 )
    print ("receipt -> results/r5_brep_gate.json")
