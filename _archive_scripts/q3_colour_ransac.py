...
Q2: yaricapla ACGOZLU esleme cakti (residual ~30mm). Sebep tanindi: a parcada onlarca vida deligi
    AYNI yaricapta; first eligible olana eslemek korelasyonu coplestiriyor. Null test de same output.
...
def main ():
    ...
    print (f"NULL  : {nul }/{tot } ({no :.3f})   <- this da yuksekse test DEGERSIZ")
    ...
    open ("results/q3_colour_ransac.json","w"),indent =1 )
    print ("receipt -> results/q3_colour_ransac.json")
