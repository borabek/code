...
WHY ONCE BU: "hayatta remaining FP'ler TP'lerle geometrik as ozdes" yargisi O GUNKU ozelliklerle
...
def main ():
    ...
    open ("results/wire_a_fp_diagnosis.json","w"),indent =1 )
    print ("receipt -> results/wire_a_fp_diagnosis.json")
