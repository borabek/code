"""GORELI + MUTLAK TABAN: part-ici goreli threshold but very low skorlu adayi yine de tutma."""
...
for fl in (0.15 ,0.20 ,0.25 ,0.30 ):
    ev (lambda m ,fl =fl :m [(o [m ]>=0.55 *o [m ].max ())&(o [m ]>=fl )],f'goreli 0.55 + mutlak baseline {fl }')
for fl in (0.20 ,0.25 ):
    ev (lambda m ,fl =fl :m [(o [m ]>=0.41 )|((o [m ]>=0.55 *o [m ].max ())&(o [m ]>=fl ))],f'global 0.41 VEYA (goreli 0.55 + baseline {fl })')
