...
so a fair scorer/target must use the manufacturer point, not an ten-surface opening midpoint.
...
def main ():
    ...
    # floor baseline ten holdout: predict the single body centroid (exercises the scorer)
    TP =FP =FN =0 
