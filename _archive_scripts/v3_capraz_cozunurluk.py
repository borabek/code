...
(B-rep graf, uzamsal duzen, uye zenginlestirme). Ayni kuyudan a bucket more.
...
def main ():
    ...
    print (f"9k adayi which part: {kap }/{len (DER )}",flush =True )

    # --- SINYAL VAR MI: matched (TP) vs unmatched (FP) adaylarda distribution
    ...
    print (f"\nADAY DUZEYI: 58 sutun {a58 :.4f} | 58+capraz {a64 :.4f} | diff {a64 -a58 :+.4f}")
