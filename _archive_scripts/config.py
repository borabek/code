...
class ConnectionPointDetectorConfig :
    ...
    """Minimum depth a 2D->3D slab is given, preventing degenerate crops ten very thin features.
    ...
    """Number of Loop subdivision steps ten the feature sub-mesh before computing v_s.
