...
Eski cluster (`d5_4_exam_set.json`, 250 part) "unseen URETICI sinavi" adiyla
...
Yani that kumede measured_path "unseen manufacturer" sayilari SISIK. Eski kumede kurtarilacak
...
Onlardan kurulan cluster, MEVCUT ckpt'ler for gercekten unseen manufacturer sinavidir
...
URETICI KAPISI n>=5 ([[unseen-manufacturer-sinavi-first-measurement]] WAGO dersi: single parcali
...
CIKTI ="results/d6_exam_set.json"
...
def main ():
    ...
    print (f"  n<{MIN_URETICI } oldugu for EGITIME birakilanlar: "
    ...
    "not":("TEMIZ unseen-URETICI sinavi (D6). Bu ureticiler no training "
