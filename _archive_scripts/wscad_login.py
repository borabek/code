"""Open WSCAD Universe in a PERSISTENT browser profile so the user can log in before.
    ...
    with sync_playwright ()as p :
        ...
        while time .time ()<deadline :
            ...
            if logged :
                ...
                ctx .close ()
                return 0 
        print ("zaman asimi -- giris detection edilemedi; pencereyi open birak and tekrar dene")
        ctx .close ()
        return 1 
