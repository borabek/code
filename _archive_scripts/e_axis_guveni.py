...
V/F/probability present; candidates turetilir, 13 feature + axis ozellikleri cikarilir, PARCA-GRUPLU
...
def main ():
    ...
    for gi ,r in enumerate (cache ):
        ...
        for i in range (len (cps )):
            ...
            # 4 feature: silindir mi, duzlem mi, never mi, and matched silindirin yaricapi
    ...
    open ("results/e_axis_guveni.json","w"),indent =1 )
