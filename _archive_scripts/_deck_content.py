...
words. No consultant phrasing ("buys you", "ten the table", "due diligence") and no long
...
def build (ctx ):
    ...
    # Satirlar sikisikti: row yuksekligi 0.36 -> 0.46 and hucre metinleri kisaltildi.
    ...
    # SINIF KIRILIMI: "5 of 5" iddiasi URUN modeli for YANLIStI (SnapPoint %45.4). Dogrusu 4/5,
    # and barajin under remaining single sinif kablolamayla ilgisi olmayan sinif -- bunu acikca yaziyorum.
    ...
    # Rejim adlari INSAN diliyle: "low-CP / high-CP" ic terminolojidir, aliciya a sey anlatmaz.
