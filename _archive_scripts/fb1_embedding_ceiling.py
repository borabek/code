...
OKUMA:
  embedding uyusmazligi BELIRGIN DUSUKSE -> ceiling yukselir, detection 0.84 (robot 0.80'in
...
def embed_al (model ,meta ,V ,F ,dev ,op_cache ):
    ...
    def kanca (mod ,entering ,produced ):
        tut ["z"]=entering [0 ].detach ()
...
def main ():
    ...
    with io .open ("results/fb1_embedding_ceiling.json","w",encoding ="utf-8")as f :
        json .dump (SON ,f ,indent =1 ,ensure_ascii =False )
    print ("receipt -> results/fb1_embedding_ceiling.json")
