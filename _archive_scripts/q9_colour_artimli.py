...
def main ():
    ...
    print (f"sira-dogrulanan part {kabul } | skipped {red } | {len (Y )} candidate | TP {int (Y .sum ())}")
    ...
    open ("results/q9_colour_artimli.json","w"),indent =1 )
    print ("receipt -> results/q9_colour_artimli.json")
