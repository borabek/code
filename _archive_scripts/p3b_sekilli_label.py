...
SORUN: `g5_mouth_label.agiz_etiketle` each CP'ye axis along DISK boyar (measured_path
yaricapla). Kare / yarik / push-in girislerde this YANLIS geometridir: disk ya agzin
kosMelerini kacirir ya da cevresindeki govdeyi boyar. Sonuc, feat-tutarlilik kapisinin
