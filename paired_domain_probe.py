...
The crux question: the SAME physical part scores F1~0.21 on its coarse Desktop-JSON
mesh but F1~0.09 on its dense WSCAD STEP twin. WHERE does it break? This runs the
winner checkpoint on three inputs per catalog and scores all against the SAME
