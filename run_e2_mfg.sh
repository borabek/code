...
#
# DENETIM BULGUSU: dagitilan 4 checkpoint yalnizca 189 mesh gordu. Diskte 257 uretici-etiketli
# parca (_mfg_labels 142 + _mfg_labels_highcp 115) duruyor ve HIC kullanilmadi.
#
# "Daha cok veri" IKI KEZ denenmis, IKISI DE KAYBETMIS -- ama IKISI DE KARISTIRILMIS deneydi:
#   H3: ayni anda (a) +257 uretici etiketi, (b) +132 EEC, (c) 4 INSAN DIZINI DUSURULDU
...
#
# BU KOSU TEK DEGISKEN OYNATIR: dagitilan tarifin AYNISI + uretici etiketleri EK olarak.
#
# SIZINTI KORUMASI (olculdu, bu yuzden TEMIZ kopyalar kullaniliyor):
...
#   Filtresiz egitim 95 LOCKED grubunun 31'ini yakardi = sinav biterdi.
#
# KILL: VAL Conn-IoU dagitilanlarin araligini (0.6378-0.6629) gecmezse kol kapanir.
set -u
...
echo "=== E2: dagitilan tarif + uretici etiketleri, k_eig 96, seed 0, $(date) ==="
echo "    insan dizinleri : $INSAN"
echo "    uretici dizinleri: $MFG"
