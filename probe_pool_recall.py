...
Onceki kosuda "candidate kahini" diye yazdigim column oracle DEGILDI: gate'siz havuzun
...
("g10 (A3-A4)","results/_der_yeni_g10.pkl")):
    ...
    print (f"{ad :<14} pool recall {rc :.4f} | total candidate {nA :>6} "
...
"not":"HAVUZ GERI CAGIRMA (F1 DEGIL). D7 brand-disi, detection tolerans, "
"aci serbest, bire-a Macar."},
open ("results/pool_recall_d7.json","w"),indent =1 )
