# -*- coding: utf-8 -*-
"""Re-measure generalisation on the 40 unseen candidates with the RETRAINED (234-part) model, and
compare to the 102-part baseline (18 clean / 6 noisy / 16 no_cableentry). Same verdict logic as
measure_generalization.py.

CORRECTION (2026-07-20, cp-v3): this "clean/no_cableentry" verdict is a HEURISTIC on UNLABELLED
...
segmentation quality (rec_augcew_s0 scored best here but worst on measure_val_cableentry.py's
