"""Drive WSCAD Universe like a human on ONE article number and dump what appears,
...
def main():
    ...
    with sync_playwright() as p:
        ...
        print(f"[3] parca linki adaylari ({len(set(links))}):")
        for u in uniq:
            print("     ", u)
        ...
        if uniq:
            ...
            print("[4] parca sayfasi:", page.url)
